const initRLS=()=>{
  ...
  if(footer){
    footer.innerHTML=`<div class="container rls-footer-inner">
      ...
      <div class="rls-footer-index-logos" aria-label="Indexing and databases">
        <a class="rls-footer-index-logo" href="https://www.magiran.com/" target="_blank" rel="noopener noreferrer" title="Magiran"><img src="${asset('magiran.png')}" alt="Magiran" loading="lazy"></a>
        <a class="rls-footer-index-logo" href="https://civilica.com/" target="_blank" rel="noopener noreferrer" title="Civilica"><img src="${asset('sivilica.png')}" alt="Civilica" loading="lazy"></a>
      </div>
    </div>`;
  }
...
footer .rls-footer-index-logos{display:flex;flex-direction:row;flex-wrap:wrap;justify-content:center;align-items:center;gap:16px;margin-top:18px;padding-top:16px;border-top:1px solid rgba(255,255,255,.22)}
footer .rls-footer-index-logo{display:flex;align-items:center;justify-content:center;width:100px;height:56px;padding:6px 10px;background:#fff;border-radius:8px;border:1px solid rgba(255,255,255,.55);box-shadow:0 3px 10px rgba(0,0,0,.1);text-decoration:none;box-sizing:border-box;flex:0 0 auto}
footer .rls-footer-index-logo img{display:block;width:auto;height:auto;max-width:88px;max-height:44px;object-fit:contain}
